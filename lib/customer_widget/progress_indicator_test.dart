...
import 'custom_paint/progress_indicator.dart';

class ProgressIndicatorTest extends StatefulWidget {
  const ProgressIndicatorTest({Key? key}) : super(key: key);

  @override
  ProgressIndicatorTestState createState() {
    return ProgressIndicatorTestState();
  }
}

class ProgressIndicatorTestState extends State<ProgressIndicatorTest>
